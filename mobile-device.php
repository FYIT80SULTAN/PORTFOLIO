...
<body class="dark-theme pl-4 pr-4">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark-1 bg-dark-1 pt-3">
        <a class="navbar-brand pl-3" href="#">Portfolio</a>
        <label class="hamburger">
            <input type="checkbox" data-toggle="collapse" data-target="#navbarTogglerDemo02"
    ...
    <div class="main-grid-1 container-fluid">
                    ...
                    <div class="col mb-4">
                        <div class="card-2">
                            ...
                            <div class="card_content">
                                ...
                                <p class="card_description">Developed a full-stack cake website with order placement, user
                                    authentication, cart management, and order tracking, utilizing
